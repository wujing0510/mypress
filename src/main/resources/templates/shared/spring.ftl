 ...
 * message
 *
 * Macro to translate a message status into a message.
 -->
<#macro message status>${springMacroRequestContext.getMessage(status)}</#macro>
 ...
 * using the given default text if no message found.
 -->
<#macro messageText status, text>${springMacroRequestContext.getMessage(status, text)}</#macro>

<#--
 * messageArgs
 *
 * Macro to translate a message status with arguments into a message.
 -->
<#macro messageArgs status, args>${springMacroRequestContext.getMessage(status, args)}</#macro>
 ...
 * using the given default text if no message found.
 -->
<#macro messageArgsText status, args, text>${springMacroRequestContext.getMessage(status, args, text)}</#macro>

<#--
 * theme
 *
 * Macro to translate a theme message status into a message.
 -->
<#macro theme status>${springMacroRequestContext.getThemeMessage(status)}</#macro>
 ...
 * using the given default text if no message found.
 -->
<#macro themeText status, text>${springMacroRequestContext.getThemeMessage(status, text)}</#macro>

<#--
 * themeArgs
 *
 * Macro to translate a theme message status with arguments into a message.
 -->
<#macro themeArgs status, args>${springMacroRequestContext.getThemeMessage(status, args)}</#macro>
 ...
 * using the given default text if no message found.
 -->
<#macro themeArgsText status, args, text>${springMacroRequestContext.getThemeMessage(status, args, text)}</#macro>
 ...
 * This function is used internally but can be accessed by user status if required.
 *
